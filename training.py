...
class CFG:
    ...
    outputs_path = f'/content/gdrive/MyDrive/modelmain/train-out'
...
for fid in fragments:
    ...
    folder_path = '/content/gdrive/MyDrive/modelmain/train-in'
    CFG.valid_id=fid
    fragment_id = CFG.valid_id
    ...
    trainer = pl.Trainer(
        ...
        devices=1,
        logger=wandb_logger,
        default_root_dir="/content/gdrive/MyDrive/modelmain/train-out",
